...
const Library = () => 
{
  ...
  return (
    ...
    <div className="main3">
      <Image
        style={{objectFit: 'cover', "border":"1px solid grey","borderRadius":"5px","width":"120px","height":"120px"}}
        placeholder={<PlaceholderImage />}
        src={`${searchParams.get('originalLink')}`}
        // src="error"
      ...
      <img
        src={arrow}
        alt="right arrow"
        style={{ width: "50px", height: "50px", margin: "0px 30px" }}
      />
      <Image
        style={{objectFit: 'cover', "border":"1px solid grey","borderRadius":"5px","width":"120px","height":"120px"}}
        src={`${searchParams.get('detectedLink')}`}
        // src="error"
        // fallback="data:image/png;base64,"
      />
    </div>
